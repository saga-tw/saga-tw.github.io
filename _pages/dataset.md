...
<table style="border: 1px solid black; border-collapse: collapse;">
    <thead>
        <tr>
            <th style="font-family: 'Work Sans'; color:#BCAB79; background-color: #545E75; border: 1px solid black;">Simulated Campaign</th>
            <th style="font-family: 'Work Sans'; color:#BCAB79; background-color: #545E75; border: 1px solid black;">Attack Stage</th>
            <th style="font-family: 'Work Sans'; color:#BCAB79; background-color: #545E75; border: 1px solid black; max-width: 450px; word-wrap: break-word;">Techniques</th>
            <th style="font-family: 'Work Sans'; color:#BCAB79; background-color: #545E75; border: 1px solid black;">Event</th>
            <th style="font-family: 'Work Sans'; color:#BCAB79; background-color: #545E75; border: 1px solid black;">MalEvent</th>
        </tr>
    </thead>
    <tbody>
        <tr>
