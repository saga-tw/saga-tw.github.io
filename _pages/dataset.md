...
author_profile: true
---
<span style="color:#be887b;font-weight:700;font-size:38px"> Comprehensive System Log Dataset for APT Attack Research </span>
This dataset consists of system logs generated by SAGA from various Advanced Persistent Threat (APT) attack scenarios, designed to support cybersecurity research. It features two categories:
<ul>
...
The following table illustrates an overview of the Known APT Campaigns dataset. Each campaign is associated with specific stages of the attack lifecycle and the techniques used in the attack.
